						...
						<div class="header-container container-xxl">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
								...
								<h1 class="d-flex flex-column text-dark fw-bold my-1">
									<span class="fs-1">생산의뢰서 상세 조회</span>
								</h1>
								<!--end::Heading-->
											...
											<div class="card-body pt-0">
												...
												<div id="kt_create_new_payment_method">
													...
													<div class="py-1">
														...
														include '../../ajax/databaselog.php';
														$data = $_GET['data'];
														$sql = "SELECT TOP(1) write_date,due_date,del_place,C.status_name AS 'product_status' ,regist_status1,status, B.acc_name,B.acc_bu_no,B.acc_phone,acc_fax,acc_add1,acc_add2 FROM dbo.regist_table A LEFT OUTER JOIN account B ON A.acc_name = B.acc_no LEFT OUTER JOIN product_status C ON A.product_status = C.pro_no WHERE A.regist_no = '$data'";
														$result = sqlsrv_query($con,$sql,$params,$options);
														$row = sqlsrv_fetch_array($result);
														...
														<div class="text-center px-4 pt-10" id="acc_content1" style="display: none;">
															<img src="assets/media/illustrations/sigma-1/4.png" alt="" class="mw-100 mh-200px">
														</div>


														<div id="acc_content2" class="collapse show fs-6 ps-10" style="">
															<!--begin::Details-->
															...
															<div class="d-flex flex-wrap py-5">
																...
																<div class="flex-equal me-5">
																	<table class="table table-flush fw-semibold gy-1">
																		<tbody><tr>
																			<td class="text-muted min-w-125px w-125px">작성자</td>
																			<td class="text-gray-800" id="acc_name"><?=$acc_name?></td>
																		</tr>
																		<tr>
																			<td class="text-muted min-w-125px w-125px">작성일</td>
																			<td class="text-gray-800" id="acc_status"><?=$write_date?></td>
																		</tr>
																		<tr>
																			<td class="text-muted min-w-125px w-125px">화물 구분</td>
																			<td class="text-gray-800" id="acc_add1"><?=$product_status?></td>
																		</tr>
																...
																<div class="flex-equal">
																	<table class="table table-flush fw-semibold gy-1">
																		<tbody><tr>
																			<td class="text-muted min-w-125px w-125px">영업 담당자</td>
																			<td class="text-gray-800" id="acc_bu_no"><?=$acc_bu_no?></td>
																		</tr>
																		<tr>
																			<td class="text-muted min-w-125px w-125px">납기일</td>
																			<td class="text-gray-800" id="acc_phone"><?=$due_date?></td>
																		</tr>
																...
																<div class="flex-equal me-5">
																	<table class="table table-flush fw-semibold gy-1">
																		...
																		<tr>
																			...
																			<td class="text-gray-800" id="acc_status"><?=$acc_fax?></td>
																		</tr>
																		<tr>
																			<td class="text-muted min-w-125px w-125px">거래처 주소</td>
																			<td class="text-gray-800" id="acc_add1"><?=$acc_add1?></td>
																		</tr>
																		<tr>
																			<td class="text-muted min-w-125px w-125px"></td>
																			<td class="text-gray-800" id="acc_add2"><?=$acc_add2?></td>
																		</tr>

																		<tr>
																			<td class="text-muted min-w-125px w-125px">배송지 주소</td>
																			<td class="text-gray-800" id=""><?=$del_place?></td>
																		</tr>
																...
																<div class="flex-equal">
																	<table class="table table-flush fw-semibold gy-1">
																		...
																		<tr>
																			...
																			<td class="text-gray-800" id="acc_phone"><?=$acc_phone?></td>
																		</tr>
																		<tr>
																			<td class="text-muted min-w-125px w-125px">Fax</td>
																			<td class="text-gray-800" id="acc_fax">13456</td>
																		</tr>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
												...
												<th class="text-end min-w-70px">Img</th>
											</tr>
											<!--end::Table row-->
										</thead>
										<!--end::Table head-->
										...
										<tbody class="text-gray-600 fw-semibold">
											...
											$sql = "SELECT regist_no, pro_count, pro_price, pro_stand, pro_height, pro_text, image_url,B.category_name as 'pro_category', C.pro_name as 'pro_name' FROM dbo.regist_data A LEFT OUTER JOIN product_category B ON A.pro_category = B.pro_no LEFT OUTER JOIN product C ON A.pro_name = C.pro_no WHERE regist_no = '$data'";
											$result = sqlsrv_query($con,$sql,$params,$options);
											...
											<tr>
												...
												<!--begin::Customer=-->
												<td>
													<span class="d-flex flex-column me-3"><span class="fw-bold pro_name"><?=$pro_name?></span><span class="text-gray-400 fw-semibold fs-6 pro_category"><?=$pro_category?></span></span>
												</td>
												<!--end::Customer=-->
												<!--begin::Status=-->

											<td><?=$pro_stand?>/<?=$pro_height?></td>
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a  class="btn btn-light btn-active-light-primary btn-sm" onclick="open_img('<?=$image_url?>');">Open
													<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
