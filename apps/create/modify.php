						...
						<div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
							<div id="kt_aside_menu" class="menu menu-column menu-rounded menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-semibold fs-6" data-kt-menu="true">
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item py-2">
									...
									$data = $_GET['data'];
									$sql = "SELECT TOP(1) write_date,due_date,del_place,product_status ,regist_status1,status, B.acc_name,B.acc_bu_no,B.acc_phone,acc_fax,acc_add1,acc_add2 FROM dbo.regist_table A LEFT OUTER JOIN account B ON A.acc_name = B.acc_no LEFT OUTER JOIN product_status C ON A.product_status = C.pro_no WHERE A.regist_no = '$data'";
									...
									<div class="menu-sub menu-sub-dropdown py-4 w-200px w-lg-225px">
										...
										<div class="menu-item">
											...
											<div class="menu-content">
												<span class="menu-section fs-5 fw-bolder ps-1 py-1">Home
									...
									<div class="menu-sub menu-sub-dropdown menu-sub-indention px-2 py-4 w-250px">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link" href="../../demo17/dist/apps/customers/view.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Customer Details</span>
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="../../demo17/dist/apps/subscriptions/add.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
											...
											<div class="card-header">
												...
												<div class="card-title">
													<h2 class="fw-bold">거래처</h2>
												</div>
												<!--begin::Card title-->
												<!--begin::Card toolbar-->
												<div class="card-toolbar">
													<a class="btn btn-light-primary" onclick="search_btn();">거래처 검색</a>
												</div>
												<!--end::Card toolbar-->
											</div>
											<!--end::Card header-->
											...
											<div class="card-body pt-0">
												...
												<div id="kt_create_new_payment_method">
													...
													<div class="py-1">
														...
														<div class="text-center px-4 pt-10" id="acc_content1">
																...
																<div class="flex-equal me-5">
																	<table class="table table-flush fw-semibold gy-1">
																		...
																		<tr>
																			...
																			<td class="text-gray-800" id=""><input type="text" id="del_place" class="form-control" name="" value="<?=$del_place?>"></td>
																		</tr>
																					...
																					<div class="card-body pt-0">
																						...
																						<div class="table-responsive">
																							...
																							<table class="table align-middle table-row-dashed fs-6 fw-semibold gy-4" id="kt_subscription_products_table">
																								...
																								<!--end::Table head-->
																								<!--begin::Table body-->
																								<tbody class="text-gray-600" id="product_body">
																								</tbody>
																								<!--end::Table body-->
																							</table>
...
<input class="form-control form-control-solid" name="calendar_event_start_date" id="datep1" value="<?=$today?>"  />
										...
										<a class="btn btn-primary" style="margin-top:5%;" onclick="insert_page();" >수정</a>
										<!--end::Card body-->
									</div>
									...
									<div class="modal-content">
										...
										<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
											...
											<div class="text-center mb-12">
												<h1 class="fw-bold mb-3">거래처 검색</h1>
										...
										<div class="modal-content">
											 ...
											 <form class="form" action="#" id="kt_modal_add_product_form">
													...
													<div class="modal-body py-10 px-lg-17">
														 <!--begin::Label-->
														 <h3 class="mb-7">
																<span class="fw-bold required">생산의뢰서 제품 추가</span>
...
<option value="">선택</option>
					 ...
					 <?php } ?>
														 ...
														 <div class="col-md-12 fv-row mb-5">
																...
																<div class="row fv-row">
																	 ...
																	 <!--begin::Col-->
																	 <div class="col-12">
																			<h4 class="fw-bold">수량</h4>
																			<input type="number" class="form-control form-control-sm form-control-solid" name="" placeholder="" value="1" id="pro_count"/>
																	 </div>
													...
													<div class="modal-footer flex-center">
														 <!--begin::Button-->
														 <button type="reset" id="" class="btn btn-light me-3" onclick="cancel();">취소</button>
														 <!--end::Button-->
														 <!--begin::Button-->
														 <button type="button" id="" class="btn btn-primary" onclick="insert_product();">
		...
		<script type="text/javascript">
			document.getElementById("employee").value="보노보노";
			function cancel(){
		...
		// table += '<a href="#" class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px me-3" onclick="remove_Tr();">';
			...
			table += '<span class="svg-icon svg-icon-3 remove_btn" onclick = "data_remove_btn(this);">';
				table += '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">';
					...
					table += '<path opacity="0.5" d="M9 4C9 3.44772 9.44772 3 10 3H14C14.5523 3 15 3.44772 15 4V4H9V4Z" fill="currentColor" />';
				table += '</svg>';
			table += '</span>';
		// table += '</a>';
	table += '</td>';
...
var table_size = $(".product_count").length;
	...
	if(table_size == 1){
		...
		$("#acc_content2").hide();
$("#acc_search").keydown(function (event) {
		//엔터키를 클릭시
		if (event.which === 13) {
				//버튼 자동 클릭
...
function search_btn(){
	// kt_modal_customer_search
$("#kt_modal_customer_search").modal('show');
// $("#acc_search").focus();
}
...
var m_data = '<?=$data?>';
get_modi(m_data);
function get_modi(data){
	$.ajax({
		type: 'post',
		dataType: 'json',
		url: './ajax/get_modi.php',
		contentType :   "application/x-www-form-urlencoded; charset=UTF-8",
		async:false, // 전역변수 설정 변수
		data : {
			data:data,
			...
			for (var i = 0; i < retVal.length; i++) {
				...
				table += '<tr class="product_count">';
					table += '<td><span class="d-flex flex-column me-3"><span class="fw-bold pro_name" id="'+retVal[i].pro_no+'" >'+retVal[i].pro_name+'</span><span class="text-gray-400 fw-semibold fs-6 pro_category" id="'+retVal[i].category_no+'">'+retVal[i].pro_category+'</span></span></td>';
						...
						table += '<td class="pro_price">'+retVal[i].pro_price+'</td>';
					table += '<td class="pro_count">'+retVal[i].pro_stand+'</td>';
				table += '<td><input type="text" class="form-control pro_text" value="'+retVal[i].pro_text+'" ></td>';
				table += '<td><span class="svg-icon svg-icon-3 img_count" onclick="open_img2(this);"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="currentColor"></path><path opacity="0.5" d="M5 5C5 4.44772 5.44772 4 6 4H18C18.5523 4 19 4.44772 19 5V5C19 5.55228 18.5523 6 18 6H6C5.44772 6 5 5.55228 5 5V5Z" fill="currentColor"></path><path opacity="0.5" d="M9 4C9 3.44772 9.44772 3 10 3H14C14.5523 3 15 3.44772 15 4V4H9V4Z" fill="currentColor"></path></svg></span></td>';
				table += '<input type="hidden" class="image_base" value='+base64+'/>';
					table += '<td class="text-end">';
...
var m_acc_name = '<?=$acc_no?>';
var m_product_status = '<?=$product_status?>';
get_search(m_acc_name);
var m_due_date = '<?=$due_date?>';
$("#datep1").val(m_due_date);
$('#product_status').val(m_product_status).prop("selected",true);
</script>
	</body>
	<!--end::Body-->
</html>
