												...
												<div class="px-7 py-5" data-kt-user-table-filter="form">
													...
													<div class="mb-10">
														...
														<select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
															...
															<option value="방충망파트">방충망파트</option>
															<option value="루버파트">루버파트</option>
											...
											<div class="modal-dialog modal-dialog-centered mw-650px">
												...
												<div class="modal-content">
													...
													<div class="modal-header" id="kt_modal_add_user_header">
														...
														<!--end::Modal title-->
														<!--begin::Close-->
														<div class="btn btn-icon btn-sm btn-active-icon-primary" onclick="cancel();">
															<!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
															<span class="svg-icon svg-icon-1">
																<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
																	<rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
														...
														<!-- <form id="kt_modal_add_user_form" class="form" action="#"> -->
															...
															<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="user_name" id="ID"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="ID" value="" />
																	<!--end::Input-->
																</div>
																...
																<div class="fv-row mb-7">
																	<!--begin::Label-->
																	<label class="required fw-semibold fs-6 mb-2">PW</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="user_name" id="PW" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="PW" value="" />
																	<!--end::Input-->
																</div>
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="user_name" id="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="" />
																	<!--end::Input-->
																</div>
																...
																<div class="fv-row mb-7">
																	<!--begin::Label-->
																	<label class="fw-semibold fs-6 mb-2">상세주소</label>
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="user_name" id="address2"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="상세주소를 입력하세요.." value="" />
																	<!--end::Input-->
																</div>
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="email" name="user_email" id="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" value="" />
																	<!--end::Input-->
																</div>
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="user_email" id="phone" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="010-123-4567" value="" />
																	<!--end::Input-->
																</div>
																...
																<div class="fv-row mb-7">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="user_email" id="description" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="" />
																	<!--end::Input-->
																</div>
																...
																<div class="mb-7">
																	<!--begin::Label-->
																	<label class="required fw-semibold fs-6 mb-5">Depart</label>
																	<!--end::Label-->
																	<!--begin::Roles-->
																	<!--begin::Input row-->
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			...
																			<label class="form-check-label" for="kt_modal_update_role_option_1">
																				<div class="fw-bold text-gray-800">조립반</div>
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			...
																			<label class="form-check-label" for="kt_modal_update_role_option_2">
																				<div class="fw-bold text-gray-800">가공반</div>
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input me-3" name="user_role" type="radio" value="4" id="kt_modal_update_role_option_3" />
																			<!--end::Input-->
																			<!--begin::Label-->
																			<label class="form-check-label" for="kt_modal_update_role_option_3">
																				<div class="fw-bold text-gray-800">방충망파트</div>
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input me-3" name="user_role" type="radio" value="5" id="kt_modal_update_role_option_4" />
																			<!--end::Input-->
																			<!--begin::Label-->
																			<label class="form-check-label" for="kt_modal_update_role_option_4">
																				<div class="fw-bold text-gray-800">루버파트</div>
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input me-3" name="user_role" type="radio" value="6" id="kt_modal_update_role_option_3" />
																			<!--end::Input-->
																			<!--begin::Label-->
																			<label class="form-check-label" for="kt_modal_update_role_option_3">
																				<div class="fw-bold text-gray-800">영업팀</div>
																				<!-- <div class="text-gray-600">Best for employees who regularly refund payments and respond to disputes</div> -->
																			</label>
																			<!--end::Label-->
																		</div>
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input me-3" name="user_role" type="radio" value="7" id="kt_modal_update_role_option_3" />
																			<!--end::Input-->
																			<!--begin::Label-->
																			<label class="form-check-label" for="kt_modal_update_role_option_3">
																				<div class="fw-bold text-gray-800">회계팀</div>
																				<!-- <div class="text-gray-600">Best for employees who regularly refund payments and respond to disputes</div> -->
																			</label>
																			<!--end::Label-->
																		</div>
																...
																<div class="mb-7" id="depart_role">
																	...
																	<div class="d-flex fv-row">
																		...
																		<div class="form-check form-check-custom form-check-solid">
																			<!--begin::Input-->
																			<input class="form-check-input me-3" name="depart_role" type="radio" value="0" checked='checked' />
																			<!--end::Input-->
																			<!--begin::Label-->
																			<label class="form-check-label" for="kt_modal_update_role_option_0">
																				<div class="fw-bold text-gray-800">관리자</div>
															...
															<div class="text-center pt-15">
																<button type="button" class="btn btn-light me-3" data-kt-users-modal-action="cancel" onclick="cancel();">취소</button>

																<button type="button" class="btn btn-primary" data-kt-users-modal-action="등록" id="insert_btn2" data-kt-indicator = "on" disabled>
																...
																<button type="button" class="btn btn-primary" data-kt-users-modal-action="등록" onclick="insert();" id="insert_btn">
											...
											for ($i=0; $i < $total; $i++) {
											 ...
											 <tr>
												 ...
												 <td class="d-flex align-items-center">
													 ...
													 <!--begin::User details-->
													 <div class="d-flex flex-column">
														 <a href="../../demo17/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1"></a>
														 <span><?=$name?></span>
													 </div>
													 <!--begin::User details-->
												 </td>
...
var depart = $("input[name='user_role']:checked").val();
get_role(depart);
});

});

function get_role(depart){
	$.ajax({
		type: 'post',
		dataType: 'json',
	...
	var table = '';
	table	+= '<label class="required fw-semibold fs-6 mb-5">Role</label>';
		// <div class='separator separator-dashed my-5'></div>
	...
	if(i == 0){
		table	+= '<div class="d-flex fv-row">';

			table	+= '<div class="form-check form-check-custom form-check-solid">';

				table	+= '<input class="form-check-input me-3" name="depart_role" type="radio" value="'+retVal[i].role_no+'" id="kt_modal_update_role_option_3" checked/>';

				table	+= '<label class="form-check-label" for="kt_modal_update_role_option_3">';
					table	+= '<div class="fw-bold text-gray-800">'+retVal[i].depart_role+'</div>';
		...
		table += "<div class='separator separator-dashed my-5'></div>";
	table	+= '<div class="d-flex fv-row">';

		table	+= '<div class="form-check form-check-custom form-check-solid">';

			table	+= '<input class="form-check-input me-3" name="depart_role" type="radio" value="'+retVal[i].role_no+'" id="kt_modal_update_role_option_3" />';
...
$.ajax({
	...
	data:{
		...
		pw:pw,      //params
		name:name,   //컬럼
		address1:address1,      //params
		address2:address2,   //컬럼
		email:email,      //params
		phone:phone,   //컬럼
		description:description,      //params
			depart:depart,      //params
			role:role,
			base64:base64,
